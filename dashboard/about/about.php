    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    <h2 class="text-2xl sm:text-3xl font-bold text-white">About Content</h2>
                    <p class="text-gray-400 text-sm sm:text-base">Manage your about content</p>
                </div>
                        ...
                        <table class="w-full text-sm text-left text-gray-400">
                            <thead class="text-xs uppercase bg-gray-700 text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 sm:px-6 py-3">Metrics</th>
                                    <th scope="col" class="px-4 sm:px-6 py-3">Created At</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-gray-700 hover:bg-gray-700">
                                    ...
                                    <td class="px-4 sm:px-6 py-4 max-w-[200px] sm:max-w-[300px] truncate">
                                    ...
                                    <td class="px-4 sm:px-6 py-4">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-base sm:text-lg font-bold text-white"><?php echo htmlspecialchars($metric['count']); ?></span>
                                                <span
                                                    class="text-xs sm:text-sm text-gray-400"><?php echo htmlspecialchars($metric['title']); ?></span>
                                            </div>
                                            <?php endforeach; ?>
                                        </div>
                                        <?php endif; ?>
                                    ...
                                    <td class="px-4 sm:px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <button type="button"
                                                class="edit-about text-blue-500 hover:text-blue-400 transition-colors duration-200"
                                                data-id="<?php echo $content['id']; ?>"
                                                data-modal-target="editAboutModal" data-modal-toggle="editAboutModal">
                                                <i class='bx bx-edit text-xl'></i>
                                            </button>
                                            <button type="button"
                                                class="delete-about text-red-500 hover:text-red-400 transition-colors duration-200"
                                                data-id="<?php echo $content['id']; ?>"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#181A20] rounded-lg shadow">
                    ...
                    <form id="createAboutForm" class="p-6" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <label class="block mb-2 text-sm font-medium text-white">Metrics (Max 2)</label>
                            <div id="metricsContainer" class="space-y-2">
                                <div class="flex gap-2">
                                    <input type="text"
                                        class="metric-count-input bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        placeholder="Enter count">
                                    <input type="text"
                                        class="metric-title-input bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <form id="editAboutForm" class="p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div id="editMetricsContainer" class="space-y-2">
                                <div class="flex gap-2">
                                    <input type="number"
                                        class="edit-metric-count-input bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        placeholder="Enter number" min="1">
                                    <input type="text"
                                        class="edit-metric-title-input bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        placeholder="Enter title">
                                    <button type="button"
        ...
        <div id="deleteAboutModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#181A20] rounded-lg shadow">
                    ...
                    <div class="p-6">
                        <p class="text-gray-300 mb-4">Are you sure you want to delete this about content? This action
                            cannot be undone.</p>
                        <div class="flex items-center justify-end space-x-2">
