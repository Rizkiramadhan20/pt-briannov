...
$result = $db->query("SELECT * FROM inspiration ORDER BY created_at DESC");
$inspirations = [];
if ($result) {
    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div class="p-6 rounded-xl bg-white shadow-lg transition-shadow duration-200">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Inspiration Images</h2>
                    <p class="text-gray-600 text-sm sm:text-base">Manage your inspiration images</p>
                </div>

                <button data-modal-target="createInspirationModal" data-modal-toggle="createInspirationModal"
        ...
        <div class="mt-6">
            ...
            <div class="flex flex-col items-center justify-center py-12 px-4">
                ...
                <h3 class="text-xl font-semibold text-gray-600 mb-2">No Inspiration Images Found</h3>
                <p class="text-gray-500 text-center mb-4">Start by adding your first inspiration image.</p>
                <button data-modal-target="createInspirationModal" data-modal-toggle="createInspirationModal"
                ...
                <table class="w-full text-sm text-left text-gray-600">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="w-20 h-20">
                                    <img src="../<?php echo htmlspecialchars($inspiration['image']); ?>"
                                        alt="Inspiration"
                                        class="w-full h-full object-contain rounded-lg bg-gray-100 p-2">
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <?php echo date('d M Y H:i', strtotime($inspiration['created_at'])); ?>
                            </td>
                            <td class="px-6 py-4">
                                <button type="button"
                                    class="delete-inspiration text-red-500 hover:text-red-400 transition-colors duration-200"
                                    data-id="<?php echo $inspiration['id']; ?>"
                                    data-modal-target="deleteInspirationModal"
                                    data-modal-toggle="deleteInspirationModal">
        ...
        <!-- Create Modal -->
        <div id="createInspirationModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="createInspirationModal">
                    ...
                    <form id="createInspirationForm" class="p-6" enctype="multipart/form-data">
                        <div class="mb-6">
                        ...
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="createInspirationModal"
        ...
        <!-- Delete Modal -->
        <div id="deleteInspirationModal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        ...
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center"
                            data-modal-hide="deleteInspirationModal">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">Are you sure you want to delete this inspiration image? This
                            action cannot be undone.</p>
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="deleteInspirationModal"
                                class="text-gray-500 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Cancel</button>
