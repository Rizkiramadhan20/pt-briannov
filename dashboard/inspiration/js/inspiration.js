...
document
  .getElementById("createInspirationForm")
  .addEventListener("submit", function (e) {
    ...
    // Send data to server
    fetch("utils/create_inspiration.php", {
      method: "POST",
      body: formData,
    })
      .then((response) => {
      ...
      .then((data) => {
        if (data.success) {
          showToast("Inspiration image uploaded successfully!", true);
...
document.querySelectorAll(".delete-inspiration").forEach((button) => {
...
document.getElementById("confirmDelete").addEventListener("click", function () {
  ...
  const modal = document.getElementById("deleteInspirationModal");
  ...
  fetch("utils/delete_inspiration.php", {
    method: "POST",
    headers: {
    ...
    .then((data) => {
      if (data.success) {
        ...
        showToast("Inspiration image deleted successfully!", true);
