    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    <h2 class="text-2xl sm:text-3xl font-bold text-white">Projects</h2>
                    <p class="text-gray-400 text-sm sm:text-base">Manage your projects entries</p>
                </div>
        ...
        <div class="mt-6">
            ...
            <div class="flex flex-col items-center justify-center py-12 px-4">
                ...
                <h3 class="text-xl font-semibold text-gray-400 mb-2">No Projects Entries Found</h3>
                ...
                <table class="w-full text-sm text-left text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4"><?php echo htmlspecialchars($project['title']); ?></td>
        ...
        <div id="deleteProjectsModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#181A20] rounded-lg shadow">
                    ...
                    <div class="p-6">
                        <p class="text-gray-300 mb-4">Are you sure you want to delete this project entry? This action
                            cannot be undone.</p>
                        <div class="flex items-center justify-end space-x-2">
