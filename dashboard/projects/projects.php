    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div class="p-6 rounded-xl bg-white shadow-lg transition-shadow duration-200">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    ...
                    <p class="text-gray-600 text-sm sm:text-base">Manage your projects entries</p>
                </div>

                <button data-modal-target="createProjectsModal" data-modal-toggle="createProjectsModal"
        ...
        <div class="mt-6">
            ...
            <div class="flex flex-col items-center justify-center py-12 px-4">
                ...
                <h3 class="text-xl font-semibold text-gray-600 mb-2">No Projects Entries Found</h3>
                <p class="text-gray-500 text-center mb-4">Start by adding your first project entry.</p>
                <button data-modal-target="createProjectsModal" data-modal-toggle="createProjectsModal"
                ...
                <table class="w-full text-sm text-left text-gray-600">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                                <?php echo htmlspecialchars($project['title']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                                <?php echo htmlspecialchars($project['description']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                                <div class="flex items-center gap-2">
                                    <button type="button"
                                        class="edit-project text-blue-500 hover:text-blue-400 transition-colors duration-200"
                                        data-id="<?php echo $project['id']; ?>"
                                        data-title="<?php echo htmlspecialchars($project['title']); ?>"
                                        data-description="<?php echo htmlspecialchars($project['description']); ?>"
                                        data-modal-target="editProjectsModal" data-modal-toggle="editProjectsModal">
                                        <i class='bx bx-edit text-xl'></i>
                                    </button>
                                    <button type="button"
                                        class="delete-project text-red-500 hover:text-red-400 transition-colors duration-200"
                                        data-id="<?php echo $project['id']; ?>" data-modal-target="deleteProjectsModal"
                                        data-modal-toggle="deleteProjectsModal">
        ...
        <!-- Create Modal -->
        <div id="createProjectsModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="createProjectsModal">
                    ...
                    <form id="createProjectsForm" class="p-6" enctype="multipart/form-data">
                        <div class="mb-4">
                        ...
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="createProjectsModal"
        ...
        <!-- Edit Modal -->
        <div id="editProjectsModal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        ...
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center"
                            data-modal-hide="editProjectsModal">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    ...
                    <form id="editProjectsForm" class="p-6">
                        ...
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="editProjectsModal"
                                class="text-gray-500 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Cancel</button>
                            <button type="submit"
        ...
        <!-- Delete Modal -->
        <div id="deleteProjectsModal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        ...
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center"
                            data-modal-hide="deleteProjectsModal">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">Are you sure you want to delete this project entry? This action
                            cannot be undone.</p>
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="deleteProjectsModal"
                                class="text-gray-500 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Cancel</button>
