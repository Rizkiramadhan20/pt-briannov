                        ...
                        <div class="mb-6">
                            ...
                            <div id="imagePreview" class="mt-4 hidden">
                                <div class="flex justify-between items-start mb-2">
                                    <p class="text-sm text-gray-300">Preview:</p>
                                ...
                                <div class="w-full max-w-xs">
                                    <img id="preview" src="#" alt="Preview"
                                        class="w-full h-auto rounded-lg bg-[#1F2937] p-2 hidden">
                                </div>
                            </div>
                        </div>
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <form id="editservicesForm" class="p-6">
                        ...
                        <div class="mb-4">
                            <label for="edit_description" class="block mb-2 text-sm font-medium ">Description</label>
