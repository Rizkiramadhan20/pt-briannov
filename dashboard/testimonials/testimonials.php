    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div class="p-6 rounded-xl bg-white shadow-lg transition-shadow duration-200">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Testimonials</h2>
                    <p class="text-gray-600 text-sm sm:text-base">Manage your testimonials entries</p>
                </div>

                <button data-modal-target="createTestimonialsModal" data-modal-toggle="createTestimonialsModal"
        ...
        <div class="mt-6">
            ...
            <div class="flex flex-col items-center justify-center py-12 px-4">
                ...
                <h3 class="text-xl font-semibold text-gray-600 mb-2">No Testimonials Found</h3>
                <p class="text-gray-500 text-center mb-4">Start by adding your first testimonial entry.</p>
                <button data-modal-target="createTestimonialsModal" data-modal-toggle="createTestimonialsModal"
                    ...
                    Add Your First Testimonial Entry
                </button>
            </div>
            <?php else: ?>
                ...
                <table class="w-full text-sm text-left text-gray-600">
                    <thead class="text-xs uppercase bg-gray-50 text-gray-600">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 whitespace-nowrap md:whitespace-normal">Job</th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                                <?php echo htmlspecialchars($testimonial['job']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap md:whitespace-normal">
                                <div class="flex items-center gap-2">
                                    <button type="button"
                                        class="edit-testimonial text-blue-600 hover:text-blue-700 transition-colors duration-200"
                                        data-id="<?php echo $testimonial['id']; ?>"
                                        data-name="<?php echo htmlspecialchars($testimonial['name']); ?>"
                                        data-job="<?php echo htmlspecialchars($testimonial['job']); ?>"
                                        data-message="<?php echo htmlspecialchars($testimonial['message']); ?>"
                                        data-modal-target="editTestimonialsModal"
                                        data-modal-toggle="editTestimonialsModal">
                                        <i class='bx bx-edit text-xl'></i>
                                    </button>
                                    <button type="button"
                                        class="delete-testimonial text-red-600 hover:text-red-700 transition-colors duration-200"
                                        data-id="<?php echo $testimonial['id']; ?>"
                                        data-modal-target="deleteTestimonialsModal"
                                        data-modal-toggle="deleteTestimonialsModal">
        ...
        <!-- Create Modal -->
        <div id="createTestimonialsModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="createTestimonialsModal">
                    ...
                    <form id="createTestimonialsForm" class="p-6" enctype="multipart/form-data">
                        <div class="mb-4">
                            ...
                            <div id="imagePreview" class="mt-4 hidden">
                                ...
                                <div class="w-full max-w-xs">
                                    <img id="preview" src="#" alt="Preview"
                                        class="w-full h-auto rounded-lg bg-gray-50 p-2 hidden">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="createTestimonialsModal"
        ...
        <!-- Edit Modal -->
        <div id="editTestimonialsModal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        <h3 class="text-xl font-semibold text-gray-900">
                            Edit Testimonial Entry
                        </h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center"
                            data-modal-hide="editTestimonialsModal">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    ...
                    <form id="editTestimonialsForm" class="p-6">
                        ...
                        <div class="mb-4">
                            <label for="edit_job" class="block mb-2 text-sm font-medium text-gray-900">Job</label>
                            <input type="text" id="edit_job" name="job"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-6">
                            <label for="edit_image" class="block mb-2 text-sm font-medium text-gray-900">Image</label>
                        ...
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="editTestimonialsModal"
                                class="text-gray-500 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Cancel</button>
                            <button type="submit"
                                class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Save
                                Changes</button>
                        </div>
                    </form>
                </div>
        ...
        <!-- Delete Modal -->
        <div id="deleteTestimonialsModal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200">
                        <h3 class="text-xl font-semibold text-gray-900">
                            Delete Testimonial Entry
                        </h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center"
                            data-modal-hide="deleteTestimonialsModal">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">Are you sure you want to delete this testimonial entry? This
                            action
                            cannot be undone.</p>
                        <div class="flex items-center justify-end space-x-2">
                            <button type="button" data-modal-hide="deleteTestimonialsModal"
                                class="text-gray-500 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Cancel</button>
