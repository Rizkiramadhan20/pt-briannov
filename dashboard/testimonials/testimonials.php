    ...
    <section class="ml-0 sm:ml-64 pt-16 sm:pt-20 px-4 sm:px-8 min-h-screen transition-all duration-200">
        <div
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    ...
                    <p class="text-gray-400 text-sm sm:text-base">Manage your testimonials entries</p>
                </div>
        ...
        <div class="mt-6">
            ...
            <div class="flex flex-col items-center justify-center py-12 px-4">
                ...
                <h3 class="text-xl font-semibold text-gray-400 mb-2">No Testimonials Found</h3>
                ...
                <table class="w-full text-sm text-left text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4"><?php echo htmlspecialchars($testimonial['job']); ?></td>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($testimonial['message']); ?></td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <button type="button"
                                        class="edit-testimonial text-blue-500 hover:text-blue-400 transition-colors duration-200"
                                    ...
                                    <button type="button"
                                        class="delete-testimonial text-red-500 hover:text-red-400 transition-colors duration-200"
                                        data-id="<?php echo $testimonial['id']; ?>"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#181A20] rounded-lg shadow">
                    ...
                    <form id="createTestimonialsForm" class="p-6" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="job" class="block mb-2 text-sm font-medium text-white">Job</label>
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#181A20] rounded-lg shadow">
                    ...
                    <form id="editTestimonialsForm" class="p-6">
                        ...
                        <div class="mb-4">
                            <label for="edit_name" class="block mb-2 text-sm font-medium text-white">Name</label>
                            <input type="text" id="edit_name" name="name"
                                class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                required>
                        </div>
                        <div class="mb-4">
                            <label for="edit_job" class="block mb-2 text-sm font-medium text-white">Job</label>
                            <input type="text" id="edit_job" name="job"
                                class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                required>
                        </div>
                        <div class="mb-4">
                            <label for="edit_message" class="block mb-2 text-sm font-medium text-white">Message</label>
        ...
        <div id="deleteTestimonialsModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#181A20] rounded-lg shadow">
                    ...
                    <div class="p-6">
                        <p class="text-gray-300 mb-4">Are you sure you want to delete this testimonial entry? This
                            action
                            cannot be undone.</p>
                        <div class="flex items-center justify-end space-x-2">
